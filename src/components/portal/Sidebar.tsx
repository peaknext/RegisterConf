  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full bg-gradient-to-b from-kram-900 via-kram-800 to-kram-900">
      ...
      <div className="p-5 border-b border-white/10">
        ...
        >
          <div className="w-11 h-11 rounded-xl bg-white/10 backdrop-blur-sm flex items-center justify-center border border-white/20 shadow-lg group-hover:scale-105 transition-transform">
            <Image
              src="/snlogo.png"
              alt="Logo"
              width={32}
